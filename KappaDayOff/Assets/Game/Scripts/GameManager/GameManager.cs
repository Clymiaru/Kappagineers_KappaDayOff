...
public class GameManager : MonoBehaviour
{
    ...
    public CharacterData            PlayerCharacter      { get; private set; } = new CharacterData();
    public WaterBalloonLauncherData WaterBalloonLauncher { get; private set; } = new WaterBalloonLauncherData();
    public AmplifiedSpeakersData    AmplifiedSpeakers    { get; private set; } = new AmplifiedSpeakersData();
    public StaticBombData           StaticBomb           { get; private set; } = new StaticBombData();
